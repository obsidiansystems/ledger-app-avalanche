...
size_t tostring128(const uint128_t *number, size_t baseParam, char *out, size_t outLength) {
    uint128_t rDiv;
    uint128_t rMod;
    uint128_t base;
    copy128(&rDiv, number);
...
size_t tostring256(const uint256_t *number, size_t baseParam, char *out, size_t outLength) {
    uint256_t rDiv;
    uint256_t rMod;
    uint256_t base;
    copy256(&rDiv, number);
