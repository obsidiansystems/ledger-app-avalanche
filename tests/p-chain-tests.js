...
describe('Staking tests', async function () {
  ...
  it.only('can sign an add validator transaction where some funds are locked', async function () {
    const txn = Buffer.from([
      0x00, 0x00,
      0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x30, 0x39,
      // blockchain ID
  ...
  it('Rejects when more tokens are timelocked on output than input', async function () {
    const txn = Buffer.from([
      0x00, 0x00,
      0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x30, 0x39,
      // blockchain ID
