describe("Basic Tests", () => {
  ...
  describe.only("X-chain Import and Export", function() {
    it("Can sign an Import transaction", async function() {
    const txn = Buffer.from([
    0x00, 0x00,
    // base tx:
    0x00, 0x00, 0x00, 0x03,
    ...
    const ui = await flowMultiPrompt(this.speculos, [
      ...
      [{header:"From P chain",body: "12345 to everest1cv6yz28qvqfgah34yw3y53su39p6kzzezmr8kz"}],
      [{header:"Fee",body:"246901233"}],
      [{header:"Finalize",body:"Transaction"}],
    ]);
    const sigPromise = this.ava.signTransaction(
      BIPPath.fromString(pathPrefix),
    ...
    it("Can sign an Export transaction", async function() {
    const txn = Buffer.from([
      // Codec ID
      0x00, 0x00,
    // base tx:
    ...
    const ui = await flowMultiPrompt(this.speculos, [
      ...
      [{header:"X to P chain",body:"12345 to everest12yp9cc0melq83a5nxnurf0nd6fk4t224fxv424"}],
